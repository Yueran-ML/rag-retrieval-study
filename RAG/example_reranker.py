...
if __name__ == '__main__':
  ...
  # For Reranking, Set to True and comment out output_name above and 
  # uncomment the three lines below the rerank Boolean.
  ...
  # Run the main loop.
  gen_stage_0(corpus, queries, rank_model_name, rerank, 
              rerank_model_name, output_name)
